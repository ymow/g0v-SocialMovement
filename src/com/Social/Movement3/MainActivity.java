...
public class MainActivity extends FragmentActivity {
	final String[] menuEntries = { "現場文字轉播","Congress Location","English Transcript","Sunflower Movement","台大法律學生挺318",
			"English Live Stream","Reports from foreign","關於"};
...
//	"議場內 樓下（五六）","議場內 樓下（音地）","青島東 北側（g0v）","濟南路 機動（g0v）","濟南路 南測","議會外(Apple)"
	final String[] fragments = { "com.Social.Movement3.LiveNote","com.Social.Movement3.SunFlowerMap","com.Social.Movement3.EnglishTranscript"
			,"com.Social.Movement3.fbSunFlowerMovement","com.Social.Movement3.fbNTULaw318"
			,	"com.Social.Movement3.vEnglish","com.Social.Movement3.ReportsForeign","com.Social.Movement3.About"
			};
